...
@section('seo')
    <?php
    $data_seo = array(
        'title' => 'Danh sách chức năng | ' . Helpers::get_setting('seo_title'),
        'keywords' => Helpers::get_setting('seo_keyword'),
        'description' => Helpers::get_setting('seo_description'),
        'og_title' => 'Danh sách chức năng | ' . Helpers::get_setting('seo_title'),
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Danh sách chức năng</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav">
                                <li class="nav-item">
                                    <a class="btn btn-danger" onclick="delete_id('module')"
                                       href="javascript:void(0)"><i class="fas fa-trash"></i> Delete</a>
                                </li>
                                <li class="nav-item">
                                    <a class="btn btn-primary"
                                       href="{{ route('admin.createModule') }}"
                                    ...
                                    $('#table_index').DataTable({
                                        ...
                                        columnDefs: [
                                            ...
                                            {// Role
                                                ...
                                                className: 'text-center',
                                                render: function (data, type, full, meta) {
                                                    return '<a href="{{route("admin.dashboard")}}/module/' +
                                                        full.id + '"><b>' + data + '</b></a>';
                                                }
                                            },
                                            {// Created
