...
<?php
$data_seo = array(
    'title' => 'List Category Post | '.Helpers::get_setting('seo_title'),
    'keywords' => Helpers::get_setting('seo_keyword'),
    'description' => Helpers::get_setting('seo_description'),
    'og_title' => 'List Category Post | '.Helpers::get_setting('seo_title'),
	        	...
	        	<div class="card">
		          	...
		          	<div class="card-body">
                        <ul class="nav">
                            ...
                            <li class="nav-item">
                                <a class="btn btn-primary" href="{{route('admin.createPostCategory')}}" style="margin-left: 6px;"><i class="fas fa-plus"></i> Add New</a>
                            </li>
                        </ul>
                        <br/>
                        ...
                        <script>
                            $(function() {
                                ...
                                $('#table_index').DataTable({
                                    data: data2,
                                    columns: [
                                      {title: '<input type="checkbox" id="selectall" onclick="select_all()">', data: 'categoryID'},
                                      {title: 'Title', data: 'categoryName'},
                                    ...
                                    {//Title
                                        ...
                                        className: 'text-center',
                                        render: function (data, type, full, meta) {
                                            return '<a href="{{route("admin.dashboard")}}/post-category/' + full.categoryID + '"><b>'+data+'</b><br/><b style="color:#c76805;">'+ full.categorySlug +'</b></a>';
                                        }
                                    },
                                    {//Thumbnail
                                        visible: true,
                                        ...
                                        render: function (data, type, full, meta) {
                                            if(data != ''){
                                                return '<img src="{{route("index")}}/images/category/'+data+'" style="height: 100px;">';
                                            } else{
