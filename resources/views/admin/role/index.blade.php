...
@section('seo')
    <?php
    $data_seo = array(
        'title' => 'Danh sách vai trò | ' . Helpers::get_setting('seo_title'),
        'keywords' => Helpers::get_setting('seo_keyword'),
        'description' => Helpers::get_setting('seo_description'),
        'og_title' => 'Danh sách vai trò | ' . Helpers::get_setting('seo_title'),
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Danh sách vai trò</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ul class="nav">
                                <li class="nav-item">
                                    <a class="btn btn-danger" onclick="delete_id('role')"
                                    ...
                                    $('#table_index').DataTable({
                                        ...
                                        columnDefs: [
                                            ...
                                            {// Role
                                                ...
                                                className: 'text-center',
                                                render: function (data, type, full, meta) {
                                                    return '<a href="{{route("admin.dashboard")}}/role/' +
                                                        full.id + '"><b>' + data + '</b></a>';
                                                }
                                            },
                                            {// Created
