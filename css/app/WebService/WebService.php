...
class WebService
{
    ...
    public function RenderBlockProduct($product): string
    {
        ...
        return '<div class="card product-card text-center">
            <a class="card-img-top d-block overflow-hidden" href="' . $productLink . '">
                    ...
                    <div class="row">
                        ...
                        <div class="carousel-custom py-lg-3">
                            <div class="tns-carousel tns-controls-static tns-controls-outside">
                                <div class="tns-carousel-inner" data-carousel-options=\'{"items": 2, "gutter": 16,"nav":false, "controls": true, "autoHeight": true, "responsive": {"0":{"items":1}, "480":{"items":2}, "720":{"items":3}, "991":{"items":2}, "1140":{"items":3}, "1300":{"items":4, "gutter": 20}, "1500":{"items":4, "gutter" : 20}}}\'>
                                    ' . $secondCol . '
                                </div>
                            </div>
                        </div>
